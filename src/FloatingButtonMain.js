...
class FloatingButtonMain extends Component {
    ...
    render() {
      ...
      componentDidMount() {
        const FloatingButton = class FloatingButton {
          constructor(svg) {
            ...
            this.text = options.text || "FloatingButton";
            this.svg = svg;
            this.layers = [
              {
                points: [],
        ...
        button.FloatingButton = new FloatingButton(button);
    ...
    export default FloatingButtonMain;